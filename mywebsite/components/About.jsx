...
export default function About(){
    ...
    <span> <h1>About</h1><p id="about-text">Hi! I&apos;m <span className="yellow-colour">Livi</span>, a <span className="orange-colour">full stack developer</span> based in Sheffield.
