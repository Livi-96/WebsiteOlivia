...
export default function Header(){
    ...
    <div id="section-one" className="work-Title">
        ...
        <div className="work-card">
            ...
            <a href="https://www.linkedin.com/posts/olivia-johnson-7465301b0_mid-term-projects-last-week-our-dream-activity-7125058048963829760-swQV?utm_source=share&utm_medium=member_desktop"> Demo </a>
            </div>
        </div>
        <div className="work-card">
            ...
            <a href="https://harvest-hub-tau.vercel.app/">Website (recommended viewing on mobile)</a>
            <br></br>
            <a href="https://github.com/pathirny/HarvestHub">GitHub Repo</a>
            </div>
        </div>
